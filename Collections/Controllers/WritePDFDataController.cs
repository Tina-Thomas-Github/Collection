...
{
    public class WritePDFDataController : Controller
    {
        private readonly IWritePDFDataBusiness _objIWritePDFDataBusiness;

        public WritePDFDataController(IWritePDFDataBusiness objIWritePDFDataBusiness)
        {
            _objIWritePDFDataBusiness = objIWritePDFDataBusiness;
        }
        // GET: WritePDFData
